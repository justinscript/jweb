...
import com.fengduo.spark.commons.core.lang.Argument;
import com.fengduo.spark.commons.core.lang.Assert;
import com.fengduo.spark.commons.core.lang.BeanUtils;
 ...
 * </pre>
 * 
 * @author zxc May 28, 2015 12:41:07 AM
 */
public class StringFormatter {
    ...
    static PeriodFormatter formatter = new PeriodFormatterBuilder().appendDays().appendSuffix("天").appendHours().appendSuffix("小时").appendMinutes().appendSuffix("分").appendSeconds().appendSuffix("秒").appendMillis3Digit().appendSuffix("毫秒").toFormatter();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getEnWordSize("60D中甜美^一^夏季吊带雪纺抹胸裙沙滩裙连衣裙"));
    }
}
